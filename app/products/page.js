...
export default async function StorePage({ searchParams }) {
  ...
  return (
    <div className="my-4 mx-4 md:mx-8 flex flex-col gap-6">
      <h3 className="text-2xl md:text-3xl font-semibold text-center border-b border-gray-100 py-6 md:py-10">
        Our Products
      </h3>
      ...
      {/* Product Grid */}
      <div className="pt-6 px-4 grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6 md:gap-10 border-t border-gray-100">
        {data.map((product) => (
          <div
            key={product._id}
